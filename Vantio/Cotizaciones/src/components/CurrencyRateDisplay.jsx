...
const CurrencyRateDisplay = ({ onRatesLoaded }) => {
    ...
    const fetchRates = async () => {
        try {
            ...
            // Fetch USD and EUR from mindicador.cl (Official Chile - Banco Central)
            ...
            const clpPerUsd = usdData.serie[0].valor;
            const clpPerEur = eurData.serie[0].valor;

            const eurPerUsd = clpPerUsd / clpPerEur;
